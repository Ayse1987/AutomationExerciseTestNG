...
public class TC24DownloadInvoiceAfterPurchaseOrder extends BaseClass {
    ...
    public void downloadInvoice() {
        ...
        Assert.assertTrue(cartPage.reviewYourOrder.isDisplayed());
        cartPage.description.sendKeys("great");
        ...
        Assert.assertTrue(cartPage.yourOrderPlacedMessage.isDisplayed());
    //indirileni assert etme?
        paymentPage.continueButton.click();
